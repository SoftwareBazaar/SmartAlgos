...
export default function SmartAlgosLogin() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-brand-900 via-brand-800 to-black flex items-center justify-center py-6">
      ...
      <button className="absolute top-6 right-6 text-blue-400 hover:text-blue-300 text-sm transition-colors">
        Proxy Settings
      </button>
      ...
      <div className="w-full max-w-sm px-6">
        ...
        <div className="bg-brand-800/50 backdrop-blur-xl rounded-xl border border-brand-700/50 shadow-2xl overflow-hidden">
          ...
          <div className="text-center py-6 px-6">
            ...
            <p className="text-brand-300 text-sm">AI Powered Trading Platform</p>
          </div>
          ...
          <form className="px-6 pb-6 space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3 py-2.5 pl-10 pr-10 bg-brand-700/50 border border-brand-600 rounded-lg text-sm text-white placeholder-brand-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all"
                  required
                />
                <Lock className="absolute left-3 top-2.5 w-4 h-4 text-brand-400" />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-2.5 w-4 h-4 text-brand-400 hover:text-primary-400 transition-colors"
                >
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center text-brand-300 cursor-pointer">
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(event) => setRememberMe(event.target.checked)}
                  className="mr-2 rounded border-brand-600 bg-brand-700 text-primary-500 focus:ring-primary-500"
                />
                Remember me
              </label>
              <Link 
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-brand-800/50 text-brand-400">New to Smart Algos?</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 bg-brand-700/50 border border-brand-600 text-white text-sm font-medium rounded-lg hover:bg-brand-700 hover:border-primary-500 transition-all"
            >
              Create Account
            </button>
          </form>
